            ...
            <div className="lg:pr-8">
              ...
              {isLoading ? (
                ...
                <p className="text-black text-lg mb-8 leading-relaxed">
                  Pre-built and customizable solutions designed to address
                  common business needs across industries, helping you go live
              ...
              {isLoading ? (
                ...
                <>
                  ...
                  <p className="text-black text-sm leading-relaxed">
                    Reusable, production-ready software products that can be
                    quickly customized to your business needs.
                  </p>
                </>
              )}
            </div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                <div className="bg-[#F8F9FF] rounded-[2rem] p-8">
                  ...
                  <p className="text-black text-sm leading-relaxed">
                    Solutions designed for enterprises that require high
                ...
                <div className="bg-[#F8F9FF] rounded-[2rem] p-8">
                  ...
                  <p className="text-black text-sm leading-relaxed">
                    Reusable components, templates, and frameworks that speed up
                ...
                <div className="bg-[#F8F9FF] rounded-[2rem] p-8">
                  ...
                  <p className="text-black text-sm leading-relaxed">
                    Comprehensive platforms designed to support complex business
                    operations and user ecosystems.
                  </p>
                </div>
              </>
            )}
            ...
            <div>
              {isLoading ? (
                ...
                <h2 className="text-4xl md:text-5xl font-bold mb-6 text-[#111827]">
                  Why Our <span className="text-[#3B82F6]">Solution Hub</span>{" "}
                  <br />
              ...
              {isLoading ? (
                ...
                <p className="text-black text-lg mb-10 leading-relaxed">
                  Our Solution Hub brings together proven architectures,
                  ready-to-scale frameworks, and real-world expertise to help
                  businesses move from idea to impact—faster, safer, and
                  smarter.
                </p>
              )}
                ...
                {isLoading
                  ? Array(4)
                      ...
                      .map((_, i) => (
                        <div
                          key={i}
                          className="flex items-center gap-4 bg-white p-5 rounded-2xl border border-gray-100"
                        >
                          <Skeleton
                            width={48}
                            height={48}
                  ...
                  : [
                      ...
                      >
                        <div
                          className={`w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 ${item.iconColor}`}
                        >
                          {item.icon}
                        </div>
