          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            {isLoading ? (
              ...
              <h2
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(90deg, #D48BB4 0%, #6391F4 100%)",
            ...
            {isLoading ? (
              ...
              <p className="text-black font-medium text-lg">
                Click on any industry to learn about the specific challenges we
                solve and how ELYSYAL helps.
              </p>
            )}
          </div>
            ...
            {isLoading
              ? Array(6)
                  ...
                  .map((_, i) => (
                    <div
                      key={i}
                      className="bg-white rounded-[20px] p-8 border border-gray-100 h-64"
                    >
                      <Skeleton
                        height={64}
                        width={64}
              ...
              : [
                  {
                    title: "Healthcare",
                    description:
                      "Digital health solutions and medical software platforms.",
                  ...
                  },
                  {
                    title: "Fintech",
                    description:
                      "Financial technology solutions and payment platforms.",
                  ...
                  },
                  {
                    title: "Education",
                    description:
                      "E-learning platforms and education technology.",
            ...
            <div className="pb-16 md:pb-24">
              ...
              {isLoading ? (
                ...
                <p className="text-black text-lg mb-10 max-lg">
                  We transform industry challenges into opportunities through
