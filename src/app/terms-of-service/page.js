                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black leading-relaxed text-lg">
                      ...
                      with these Terms. If you do not agree, please discontinue
                      use of the site.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black leading-relaxed text-lg">
                      ...
                      technical, or legal advice, nor does it represent a
                      binding offer of services.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section id="services-engagement" className="scroll-mt-32">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black leading-relaxed text-lg">
                      All services offered by ELYSYAL—including AI, blockchain,
                      and custom software development—are delivered only under a
                      separate written agreement. Website content is
              ...
              <section id="intellectual-property" className="scroll-mt-32">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black leading-relaxed text-lg">
                      All materials displayed on this website, including text,
                      graphics, logos, and design elements, are the intellectual
                      property of ELYSYAL unless otherwise stated. Unauthorized
              ...
              <section id="limitation-of-liability" className="scroll-mt-32">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black leading-relaxed text-lg">
                      ELYSYAL shall not be liable for any loss or damage arising
                      from reliance on information presented on this website or
                      from its use. The website is provided "as is" without
              ...
              <section id="modifications" className="scroll-mt-32">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black leading-relaxed text-lg">
                      We reserve the right to modify or discontinue any part of
                      the website or these Terms at any time without prior
                      notice. Continued use constitutes acceptance of updated
                      terms.
                    </p>
                  </div>
                </div>
              ...
              <section id="governing-law" className="scroll-mt-32">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black leading-relaxed text-lg">
                      These Terms are governed by applicable local laws. Any
                      disputes arising from use of the website shall be subject
