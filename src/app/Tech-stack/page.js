...
export default function Techstack() {
  ...
  return (
    <ServicePageLayout
      ...
      title={
        <>
          Built <span className="font-normal">on Proven</span> Technology,{" "}
          <br /> <span className="font-normal   ">Designed for</span> What’s
          Next
        </>
      }
      ...
      secondaryButton={{
        ...
        icon: (
          <div className="w-6 h-6 rounded-full border border-blue-600 flex items-center justify-center bg-white">
            <svg
              className="w-2.5 h-2.5 text-blue-600 ml-0.5"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            {isLoading ? (
              ...
              <h2
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(90deg, #A49EF0 0%, #5B8bf3 100%)",
            ...
            {isLoading ? (
              ...
              <p className="text-black font-medium text-lg leading-relaxed">
                We select technologies that balance speed, reliability, and
                flexibility. Our stack supports rapid development while ensuring
            ...
            {[
              {
                ...
                description:
                  "Modern frontend frameworks used to create fast, responsive, and user-friendly interfaces across web and mobile platforms.",
                reason:
                  "Delivers smooth user experiences, faster UI development, and consistent design across devices.",
                iconGradient:
                  "linear-gradient(135deg, #7C9EF2 0%, #3B82F6 100%)",
                icon: "/icons/frontend.svg",
              },
              {
                title: "Backend Technologies",
                description:
                  "Scalable backend systems that handle business logic, APIs, and data processing efficiently and securely.",
                reason:
                  "Ensures performance, reliability, and easy integration with third-party services as systems grow.",
                iconGradient:
                  "linear-gradient(135deg, #A49EF0 0%, #8B5CF6 100%)",
                icon: "/icons/backend.svg",
              },
              {
                title: "DevOps Tools",
                description:
                  "Automation tools for continuous integration, deployment, testing, and monitoring across environments.",
                reason:
                  "Reduces deployment risk, speeds up releases, and maintains consistent quality.",
                iconGradient:
                  "linear-gradient(135deg, #7C9EF2 0%, #10B981 100%)",
                icon: "/icons/devops.svg",
              },
              {
                title: "Cloud Platforms",
                description:
                  "Cloud-native platforms used to host, scale, and manage applications globally with high availability.",
                reason:
                  "Provides flexibility, cost efficiency, and the ability to scale infrastructure on demand.",
                iconGradient:
                  "linear-gradient(135deg, #A49EF0 0%, #EC4899 100%)",
            ...
            <div>
              {isLoading ? (
                ...
                <h2 className="text-4xl md:text-5xl font-bold mb-10 leading-tight text-[#111827]">
                  Why our{" "}
                  <span className="text-[#6391F4]">technology choices</span>{" "}
