  ...
  const features = [
    {
      ...
      description:
        "Advanced AI models for content generation, image creation, automated content production at scale.",
    },
    {
      number: "02",
      title: "AI Agent Development",
      description:
        "Intelligent autonomous agents that handle complex tasks, make decisions, and automate workflows.",
    },
    {
      number: "03",
      title: "Machine Learning Development",
      description:
        "Custom ML solutions for predictive analytics, pattern recognition, and intelligent data processing.",
    },
    {
      number: "04",
      title: "Chatbot Development",
      description:
        "Advanced AI chatbots that generate natural, context-aware conversations to enhance customer engagement.",
    },
    {
      number: "05",
    ...
    },
    {
      ...
      description:
        "Engage via text, voice, and visuals for seamless cross-platform user experiences.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <section
        ...
        style={{ background: "linear-gradient(to right, #CCD4F0, #DEDBF0)" }}
      >
        <div className="mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-black text-lg leading-relaxed max-w-4xl mx-auto mb-10">
            AI agents are autonomous software systems designed to perform tasks,
            make decisions, and interact with users with minimal human input.
            They mimic human problem-solving and adapt dynamically to new
            information, enabling businesses to automate workflows, provide
            instant support, and optimize operations. Build intelligent AI
            agents that think, act, and learn independently.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-center gap-12 lg:gap-24">
          <div className="w-full md:w-1/2 lg:w-5/12 text-center md:text-left">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-8">
              <span className="text-[#6391F4]">End-to-End Artificial</span>
              <br />
              <span className="text-[#6391F4]">Intelligence</span>
              <br />
              <span className="text-[#C86B98]">Development</span>
              <br />
              <span className="text-[#C86B98]">Services</span>
            </h2>
            <p className="text-black text-lg leading-relaxed max-w-xl mx-auto md:mx-0">
              Our AI development services cover everything from intelligent
              model design to real-world deployment. By combining generative AI,
              machine learning, conversational interfaces, and computer vision,
              we deliver solutions that streamline operations, enhance
              decision-making, and help organizations innovate with confidence.
            </p>
          </div>
      ...
      <CallToAction
        title={
          <>
            Ready to{" "}
            <span className="text-[#548BF8]">Embrace AI Innovation?</span>
          </>
        }
