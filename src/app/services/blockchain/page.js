...
export default function BlockchainPage() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Feature-rich platforms for creating, trading and digital collectibles.",
    },
    {
      number: "09",
  ...
  return (
    ...
    >
      ...
      <section
        className="pt-8 sm:pt-12 lg:pt-0 pb-0"
        style={{ background: "linear-gradient(to right, #E2E6FA, #EFEEF9)" }}
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-end">
            ...
            <div className="space-y-4 sm:space-y-6 pb-6 sm:pb-10 lg:pb-24 pt-4 lg:pt-24">
              <h2 className="text-2xl sm:text-3xl lg:text-5xl font-bold leading-snug text-black">
                <span className="text-[#6391F4]">
                  Building Blockchain Solutions
                </span>{" "}
                That Fits Your Business
              </h2>
              <p className="text-black text-sm sm:text-base lg:text-lg leading-relaxed">
                We deliver tailored blockchain solutions that address complex
                business challenges and evolving technical needs. From scalable
                DeFi platforms and secure smart contracts to enterprise-grade
                DApps and NFT marketplaces, our development approach ensures
                reliability, transparency, and seamless integration across your
      ...
      <CallToAction
        title={
          <>
            Ready to{" "}
            <span className="text-[#548BF8]">Build on Blockchain?</span>
          </>
        }
