...
export default function CustomSoftwarePage() {
  ...
  return (
    ...
    >
      ...
      <section
        className="pt-8 sm:pt-12 lg:pt-24 pb-0"
        style={{ background: "linear-gradient(to right, #DCE6F9, #E3E7FA)" }}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-2 md:gap-12">
          <div className="w-full md:w-1/2 text-left pb-0 md:pb-24">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight">
              <span className="text-[#6391F4]">Software</span>{" "}
            ...
            <p className="text-black text-sm sm:text-base lg:text-lg leading-relaxed mb-4 sm:mb-6">
              We deliver tailored software solutions that address complex
              business challenges and evolving technical needs. From enterprise
              applications and SaaS platforms to scalable microservices, ERP
              systems, and embedded software, our development approach ensures
              reliability, performance, and seamless integration across your
              digital ecosystem.
            </p>
          </div>
      ...
      <CallToAction
        title={
          <>
            Let's <span className="text-[#548BF8]">Build Your Software</span>
          </>
        }
