        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 relative">
          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            <div className="space-y-12">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black leading-relaxed text-lg">
                      The ELYSYAL website is intended to provide general
                      information about our services, capabilities, and business
                      offerings. Visitors may browse the site without providing
              ...
              <section id="information-handling" className="scroll-mt-32">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black leading-relaxed text-lg">
                      Any information voluntarily shared with ELYSYAL through
                      direct communication channels (such as email or business
                      inquiries) is used solely for professional correspondence,
                      service discussions, or responding to requests. Such
                      information is not used for unsolicited communication.
                    </p>
                  </div>
                </div>
              </section>
              ...
              <section
                id="use-of-website-technologies"
              ...
              >
                <div className="flex gap-4">
                  ...
                  <div>
                    <h2 className="text-2xl md:text-3xl font-medium mb-4">
                      Use of Website Technologies
                    </h2>
                    <p className="text-black leading-relaxed text-lg">
                      The website may use basic technical mechanisms necessary
                      for secure and reliable operation. These are used only to
                      ensure proper functionality and performance of the site.
                    </p>
                  </div>
                </div>
              </section>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black leading-relaxed text-lg">
                      ...
                      reference or convenience. ELYSYAL does not control and is
              ...
              <section id="information-security" className="scroll-mt-32">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black leading-relaxed text-lg">
                      We take reasonable measures to ensure that any information
                      shared with us through legitimate business communication
                      is handled responsibly and protected against unauthorized
                      access.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black leading-relaxed text-lg">
                      ...
                      changes in legal requirements or business practices.
                      Updates will be reflected on this page with a revised
                      effective date.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-black leading-relaxed text-lg mb-2">
                      For questions or concerns related to privacy, please
                      contact:
                    </p>
                    <a
                      href="mailto:hello@elysyal.com"
