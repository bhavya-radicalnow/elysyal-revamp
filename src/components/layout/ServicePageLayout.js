          ...
          {/* Background Image */}
           <div className="absolute top-0 left-0 w-full h-full -z-10">
             <Image 
               ...
               alt="Background" 
               fill 
               className="object-cover object-center opacity-50 mix-blend-overlay" // Added opacity/blend to ensure text readability if image is strong, adjust as needed. Or just clean image.
               priority
             />
